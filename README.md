...
- All you need is: DisplayDriver, NvContainer, PhysX and possibly HD Audio (Audio via HDMI cable) or USB Type-C Port device (Display via usb-c cable). For laptops its recommended to add also NVIDIA Platform Controllers
### **Usage**
